...
import com.hand.entity.AddressMapper;
...
public class CustomerDaoImpl implements ICustomerDao {
	...
	public void create(Integer store_id,String first_name,String last_name,String email,String address) {
		String SQL = "insert into Customer(store_id,first_name,last_name,email,address) values(?,?,?,?,?,?)";
		jdbcTemplateObject.update(SQL,store_id,first_name,last_name,email,address);
	...
	public List<Customer> listCustomers() {
		String SQL = "select first_name,last_name,email,customer_id,last_update,address_id from Customer";
	...
	public void update(Integer customer_id, String first_name,String last_name,String email) {
		...
		System.out.println("Update Record with ID = " + customer_id);
		return;
